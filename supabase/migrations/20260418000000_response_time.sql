-- Store response time per player answer (for per-question avg time on results screen).
-- submit_answer already computes v_elapsed; this migration persists it.

alter table player_answers add column response_time_ms integer;

-- Updated submit_answer: store response_time_ms alongside points_earned.
