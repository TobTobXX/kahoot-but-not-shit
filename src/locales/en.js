export default {
  ...
  faq: {
    title: 'FAQ',
    q1: 'How do I join a game?',
    a1: 'On the home page, enter the 6-character join code your host has shared, pick a nickname, and press Join. No account needed.',
    q2: 'How do I host a game?',
    a2: 'Go to Browse to find a public quiz, or to Library if you are logged in. Click Host next to any quiz and share the join code with your players.',
    q3: 'Do I need an account?',
    a3: 'Players never need an account. Hosts can browse and start sessions without one too. An account is only required to create and save your own quizzes.',
    q4: 'How do I create a quiz?',
    a4: 'Sign up for a free account, then click Create Quiz in the header. Add as many questions as you like, set time limits and point values, and save when done.',
    q5: 'What devices are supported?',
    a5: 'Any modern browser on phone, tablet, or desktop works. No app download needed.',
    q6: 'Is Groupquiz open source?',
    a6: 'Yes! The source code is available on Codeberg. You can self-host your own instance — there are no artificial limits.',
  },
  questionEditor: {
